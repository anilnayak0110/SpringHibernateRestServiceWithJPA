package com.anilnayak.spring.rest.client;
...
{
    public static final String REST_BASE_URI = "http://localhost:2011/SpringRestHibernateStudentServices";
    ...
    public static void getAllStudents()
    {
        ...
        List<Map<String, Object>> studentList = restTemplate.getForObject(REST_BASE_URI + "/allstudents", List.class);
        if (studentList != null)
        {
